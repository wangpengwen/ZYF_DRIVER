...
public abstract class ConfirmPopup<V extends View> extends BottomPopup<View> {
    ...
    protected View makeHeaderView() {
        ...
        topButtonLayout.setLayoutParams(new RelativeLayout.LayoutParams(MATCH_PARENT, Utils.dip2px(activity, 40)));
        topButtonLayout.setBackgroundColor(topBackgroundColor);
        topButtonLayout.setGravity(Gravity.CENTER_VERTICAL);

        Button cancelButton = new AppCompatButton(activity);
        ...
        int margin = Utils.dip2px(activity, 20);
        ...
        Button submitButton = new AppCompatButton(activity);
