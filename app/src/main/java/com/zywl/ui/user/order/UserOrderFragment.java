...
import com.zywl.ui.user.UserViewModel;
...
public class UserOrderFragment extends BaseLiveDataFragment<UserOrderViewModel> {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        List<String> titles = Lists.newArrayList(getString(R.string.text_unfinished), getString(R.string.text_finished), getString(R.string.text_cod));
        List<Fragment> fragments = Lists.newArrayList(UserOrderListFragment.newInstance(UserOrderListFragment.TYPE_UNFINISHED),UserOrderListFragment.newInstance(UserOrderListFragment.TYPE_FINISHED),UserOrderListFragment.newInstance(UserOrderListFragment.TYPE_COD));
