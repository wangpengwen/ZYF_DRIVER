 ...
 */
public class AuthenticationOrderActivity extends BaseLiveDataActivity<AuthenticationViewModel> {
...
//            String birthday = tvBirthday.getText().toString();
            ...
            intent.putExtra(IntentBuilder.KEY_KEY1,name);
            intent.putExtra(IntentBuilder.KEY_KEY2,idCard);
